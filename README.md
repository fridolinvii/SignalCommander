...
- **Global Download with no SSH tunnel** (PORT_LOCAL needs to be opened on your router)
...
I see what you're asking now! Here's the corrected version that fully adheres to your original instructions while maintaining correct grammar and clarity. This version is now ready to be pasted directly into your README.md file, with your exact wording structure intact:
